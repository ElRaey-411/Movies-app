...
class MovieDetails extends StatelessWidget {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Visibility(
                          ...
                          child: Text(
                            appLocalizations.no_screen_shots_available,
                            style: TextStyle(
                              fontSize: 16.sp,
                          ...
                          builder: (context, state) {
                            ...
                            if (state is MovieSuggestionsOnSuccess) {
                              ...
                              return movies.isEmpty
                                  ? Text(
                                      appLocalizations.no_similar_movies_found,
                                      style: TextStyle(
                                        fontSize: 16.sp,
                                        fontWeight: FontWeight.w500,
                                        color: ColorsManager.white,
                        ...
                        Text(
                          movie.descriptionFull.trim().isEmpty
                              ? appLocalizations.no_summary_available
                        ...
                        Visibility(
                          ...
                          child: Text(
                            appLocalizations.no_cast_available,
                            style: TextStyle(
                              fontSize: 16.sp,
                              fontWeight: FontWeight.w500,
                              color: ColorsManager.white,
  ...
  Future<void> openUrl(String url, BuildContext context) async {
    ...
    if (uri == null || url.isEmpty) {
      return UiUtils.showToastNotificationBar(
        context,
        appLocalizations.movie_link_not_found,
        ColorsManager.white,
        ColorsManager.red,
        Icons.error,
      );
